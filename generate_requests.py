...
# Fix paths to always be relative to this file's location
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# Load snapshot-based model metadata
with open(os.path.join(BASE_DIR, "app/data/model_state.json"), "r") as f:
...
df.to_csv(os.path.join(BASE_DIR, "app/data/mock_requests.csv"), index=False)
